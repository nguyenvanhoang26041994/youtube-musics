...
const Item = ({ name, index, img, singersName }) => (
  <div className="flex h-10 items-center cursor-pointer">
    <div className="text-white text-2xs font-mono w-10 flex justify-center items-center">{index}</div>
...
const RankingBoard = ({ className, musics }) => {
  return (
    <div className={cn('ui-ranking-board flex flex-col', className)}>
      <h2 className="flex justify-center items-center text-3xl text-teal-500 font-bold">TOP</h2>
